...
export const tableConfig = {
  ...
  // 列表数据
  recordFields: ['content', 'list', 'data', 'records', 'items', 'result', 'rows'],
  // 总条数
  totalFields: ['page.totalElements', 'total', 'count'],
  // 当前页码
  currentFields: ['page.number', 'current', 'page', 'pageNum'],
  // 每页大小
  sizeFields: ['page.size', 'pageSize', 'limit'],
